...
static int shutdown() {
    LOG(ERROR) << "Oneplus Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "Oneplus Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "Oneplus Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
